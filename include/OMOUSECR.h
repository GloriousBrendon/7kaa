...
public:
	...
	char  frame_top_save_scr[VGA_MAX_WIDTH+4];		// for saving the nation selection frame
	char  frame_bottom_save_scr[VGA_MAX_WIDTH+4];	// +4 is for the width & height info
	char  frame_left_save_scr[VGA_MAX_HEIGHT+4];
	char  frame_right_save_scr[VGA_MAX_HEIGHT+4];
