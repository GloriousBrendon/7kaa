...
public:
	...
	ButtonCustomGroup scroll_mode_group;
	ButtonCustomGroup wide_view_group;
	...
	char	old_scroll_sub_pixel;
	char	scroll_mode_changed;

	char	old_wide_viewport;
	char	wide_viewport_changed;
