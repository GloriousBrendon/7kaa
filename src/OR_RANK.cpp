...
enum { NATION_BROWSE_X1 = ZOOM_LEGACY_X1+6,
		 NATION_BROWSE_Y1 = ZOOM_LEGACY_Y1+6,
		 NATION_BROWSE_X2 = ZOOM_LEGACY_X2-6,
		 NATION_BROWSE_Y2 = NATION_BROWSE_Y1+220,
	 };

enum { NATION_SCORE_X1 = ZOOM_LEGACY_X1+6,
		 NATION_SCORE_Y1 = NATION_BROWSE_Y2+6,
		 NATION_SCORE_X2 = ZOOM_LEGACY_X2-6,
		 NATION_SCORE_Y2 = NATION_SCORE_Y1+150,
	 };

enum { NATION_GOAL_X1 = ZOOM_LEGACY_X1+6,
		 NATION_GOAL_Y1 = NATION_SCORE_Y2+6,
		 NATION_GOAL_X2 = ZOOM_LEGACY_X2-6,
		 NATION_GOAL_Y2 = NATION_GOAL_Y1+110,
	 };

enum { PLAY_TIME_X1 = ZOOM_LEGACY_X1+6,
		 PLAY_TIME_X2 = ZOOM_LEGACY_X2-6,
	 };
